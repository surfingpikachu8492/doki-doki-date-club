...
image intro:
    ...
    0.5
    "bg/splash-glitch2.png" with vpunch # pixellated salvato logo
    0.25
    "bg/splash-glitch.png" with hpunch  # screen tear salvato logo
    0.25
    "bg/sj_splash-white-glitched2.png" with hpunch  # screen tear silverjack logo
    0.25
    "bg/sj_splash_glitched.png" with vpunch  # screen tear no bars
    0.25
    "bg/splash.png" with pixellate  # ...and the normal silverjack logo
    3.2
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        with Dissolve(1.0)
        pause 1.0
        "Doki Doki Date Club is a fan-made mod created by Team SilverJack intended to turn the original game into a regular visual novel."
        "It is not a commercial project by any means and is completely free for distribution."
        "In addition, this is a demo version (v0.2.0) of DDDC. All content is subject to change."
        ...
        menu:
            "By playing Doki Doki Date Club, you agree that you are at least 13 years of age, you have played the original game, and you consent to your exposure of highly disturbing content."
            "I agree.":
                pass
